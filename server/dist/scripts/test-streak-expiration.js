...
async function testStreakExpiration() {
    ...
    try {
        ...
        await UserProgress.findOneAndUpdate({ userId: user._id }, { lastActivityDate: yesterday, streak: 1 });
        progress = await StreakService.updateStreak(user._id);
        ...
        await UserProgress.findOneAndUpdate({ userId: user._id }, { lastActivityDate: twoDaysAgo, streak: 2 });
        progress = await StreakService.updateStreak(user._id);
        ...
        await UserProgress.findOneAndUpdate({ userId: user._id }, { lastActivityDate: threeDaysAgo, streak: 3 });
        progress = await StreakService.updateStreak(user._id);
        ...
        await UserProgress.findOneAndUpdate({ userId: user._id }, { lastActivityDate: twoDaysAgoDate, streak: 5 });
...
//# sourceMappingURL=test-streak-expiration.js.map