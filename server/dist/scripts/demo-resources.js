...
const demoJobs = async () => {
    ...
    fullTimeJobs.data.jobs.forEach((job) => {
...
const demoGrants = async () => {
    ...
    grants.data.grants.forEach((grant) => {
...
const demoServices = async () => {
    ...
    allServices.data.services.forEach((service) => {
    ...
    legalServices.data.services.forEach((service) => {
...
const demoNews = async () => {
    ...
    allNews.data.news.forEach((article) => {
    ...
    importantNews.data.news.forEach((article) => {
        console.log(`   - ${article.title}`);
    });
    // Limit results
    ...
    limitedNews.data.news.forEach((article) => {
        console.log(`   - ${article.title}`);
    });
    console.log('\n' + '='.repeat(60) + '\n');
};
