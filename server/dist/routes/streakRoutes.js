...
router.post('/update', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const userId = new mongoose.Types.ObjectId(req.user._id);
...
router.get('/statistics', requireUser(['admin']), async (req, res) => {
    try {
...
router.post('/reset-expired', requireUser(['admin']), async (req, res) => {
    try {
...
router.post('/reset', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const userId = new mongoose.Types.ObjectId(req.user._id);
...
//# sourceMappingURL=streakRoutes.js.map