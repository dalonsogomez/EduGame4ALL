  ...
  try {
    ...
    const games = [
      // Language Games
      {
        ...
        description:
          'Master fundamental English vocabulary and grammar through interactive exercises.',
        category: 'language',
        difficulty: 1,
        duration: 10,
        xpReward: 50,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation:
              'This varies by company culture, though it\'s becoming more accepted.',
            points: 15,
          },
        ],
      },
    ...
    const resources = [
      // Jobs
      {
        ...
        description:
          'Join our team as a customer service representative. Bilingual candidates encouraged to apply.',
      ...
      },
      {
        ...
        address: '456 Education Ave, New York, NY 10002',
        phone: '(555) 234-5678',
        email: 'classes@learningcenter.org',
      ...
      },
      {
        ...
        address: '789 Career Blvd, New York, NY 10003',
        phone: '(555) 345-6789',
        email: 'jobs@newhorizons.org',
      ...
      },
      {
        ...
        address: '321 Health Plaza, New York, NY 10004',
        phone: '(555) 456-7890',
        email: 'help@healthaccess.org',
        hours: 'Mon-Fri 8:00 AM - 7:00 PM, Sat 9:00 AM - 1:00 PM',
        languages: ['English', 'Spanish', 'Russian', 'Bengali'],
        isFree: true,
      ...
      },
      {
        ...
        address: '654 Housing Way, New York, NY 10005',
        phone: '(555) 567-8901',
        email: 'housing@communityalliance.org',
      ...
      // News
      {
        ...
        description:
          'City announces comprehensive support program for new immigrants including job training and language classes.',
        summary:
          'City announces comprehensive support program for new immigrants including job training and language classes.',
        category: 'important',
        ...
        imageUrl: '',
        content:
          'The city has launched a new comprehensive support program designed to help immigrants integrate into their new community. The program includes free job training workshops, language classes, and mentorship opportunities with established community members.',
      ...
      },
      {
        ...
        summary: 'Recent changes to immigration policies and how they may affect you.',
        category: 'important',
        ...
        imageUrl: '',
        content:
          'Several important policy updates have been announced this month. These changes affect visa processing times, work permit requirements, and family reunification procedures. It is important to stay informed about these updates.',
      ...
      },
      {
        ...
        description:
          'Inspiring story of an immigrant who built a successful business in their new community.',
        summary:
          'Inspiring story of an immigrant who built a successful business in their new community.',
        category: 'community',
        ...
        imageUrl: '',
        content:
          'Meet Ahmed, who arrived as a refugee three years ago with nothing but hope and determination. Today, he runs a successful catering business that employs 15 people and serves the local community.',
      ...
      },
      {
        ...
        summary: 'Local organization offering free citizenship test preparation classes.',
        category: 'events',
        ...
        imageUrl: '',
        content:
          'The Community Learning Center is offering free citizenship test preparation classes starting next month. Classes will cover civics, English language skills, and interview preparation. Registration opens next week.',
      ...
      },
      {
        ...
        description: 'Annual multicultural festival brings together communities from around the world.',
        summary: 'Annual multicultural festival brings together communities from around the world.',
        category: 'culture',
        ...
        imageUrl: '',
        content:
          'The annual Cultural Festival will take place this weekend, featuring food, music, and performances from over 30 different countries. The event is free and open to all community members.',
